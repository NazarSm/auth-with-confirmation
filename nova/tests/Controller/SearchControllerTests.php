...
trait SearchControllerTests
{
    public function test_can_retrieve_search_results_for_all_searchable_resources()
    {
        ...
        $this->assertEquals('http://auth.com/nova/resources/posts/'.$post->id, $original[1]['url']);
        ...
        $this->assertEquals('http://auth.com/nova/resources/users/'.$user->id, $original[2]['url']);
